        ...
        <div className="glass rounded-3xl p-10 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <motion.button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-4 rounded-2xl bg-white hover:bg-gray-100 text-gray-800 font-semibold text-base transition-all duration-300 shadow-lg hover:shadow-xl cursor-pointer"
            >
